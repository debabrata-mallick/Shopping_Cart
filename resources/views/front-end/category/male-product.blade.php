                                ...
                                <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Men's Wear</label>
                                    <ul>
                                        <li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
                                            <ul>
                                                <li><a href="{{route('/male-product')}}">Shirts</a></li>
                                                <li><a href="{{route('/male-product')}}">Caps</a></li>
                                                <li><a href="{{route('/male-product')}}">Shoes</a></li>
                                                <li><a href="{{route('/male-product')}}">Pants</a></li>
                                                <li><a href="{{route('/male-product')}}">SunGlasses</a></li>
                                                <li><a href="{{route('/male-product')}}">Trousers</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="top-rates">
                            ...
                            <div class="recent-grids">
                                <div class="recent-left">
                                    <a href="{{ route('single-product') }}"><img class="img-responsive " src="{{asset('/')}}/front-end/images/r.jpg" alt=""></a>
                                </div>
                                <div class="recent-right">
                                    <h6 class="best2"><a href="{{ route('single-product') }}">Lorem ipsum dolor </a></h6>
                            ...
                            <div class="recent-grids">
                                <div class="recent-left">
                                    <a href="{{ route('single-product') }}"><img class="img-responsive " src="{{asset('/')}}/front-end/images/r1.jpg" alt=""></a>
                                </div>
                                <div class="recent-right">
                                    <h6 class="best2"><a href="{{ route('single-product') }}">Duis aute irure </a></h6>
                            ...
                            <div class="recent-grids">
                                <div class="recent-left">
                                    <a href="{{ route('single-product') }}"><img class="img-responsive " src="{{asset('/')}}/front-end/images/r2.jpg" alt=""></a>
                                </div>
                                <div class="recent-right">
                                    <h6 class="best2"><a href="{{ route('single-product') }}">Lorem ipsum dolor </a></h6>
                            ...
                            <div class="recent-grids">
                                <div class="recent-left">
                                    <a href="{{ route('single-product') }}"><img class="img-responsive " src="{{asset('/')}}/front-end/images/r3.jpg" alt=""></a>
                                </div>
                                <div class="recent-right">
                                    <h6 class="best2"><a href="{{ route('single-product') }}">Ut enim ad minim </a></h6>
                                        ...
                                        <div class="product-tab">
                                            <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                <div class="grid-arr">
                                                    ...
                                                    <div class="women">
                                                        <h6><a href="{{ route('single-product') }}">Sed ut perspiciatis unde</a></h6>
